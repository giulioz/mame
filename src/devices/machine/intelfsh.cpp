...
DEFINE_DEVICE_TYPE(FUJITSU_29F800B_16BIT,    fujitsu_29f800b_16bit_device,    "mbm29f800b_16bit",         "Fujitsu MBM29F800B Flash (16-bit)")
...
fujitsu_29f800b_16bit_device::fujitsu_29f800b_16bit_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock)
	: intelfsh16_device(mconfig, FUJITSU_29F800B_16BIT, tag, owner, clock, 0x100000, MFG_FUJITSU, 0x2258) { m_bot_boot_sector = true; }
